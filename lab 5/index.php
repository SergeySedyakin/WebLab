...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($email) && !empty($category) && !empty($title) && !empty($text))
    {
        ...
        {//меняем @ на $, чтобы создать директорию, так как первый символ недопустим в названии папок
...
<body>
    ...
    <form method="post">
        ...
        <br>
        <textarea name="textarea" cols="100" rows="10"  required>Здесь могло быть ваше объявление...</textarea>
        <br>
